...
![The Swiss cheese model to ensure high-quality output](./swiss-cheese-model-codebase.svg)
...
![Agent docs example PR comment](./agent-docs-example.png)
...
![AI issue triage comment example](./ai-issue-triage.png)
...
![AI PR review comment example](./ai-pr-review.png)
